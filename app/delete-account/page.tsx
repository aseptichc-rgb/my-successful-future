...
export const metadata: Metadata = {
  title: "계정·데이터 삭제 · Anima",
  description:
    "Anima 계정과 관련 데이터를 삭제하는 방법, 삭제되는 데이터와 보관되는 데이터를 안내합니다.",
    ...
    <div className="min-h-screen bg-[#F0EDE6]">
      ...
      <main className="mx-auto max-w-3xl px-5 pb-20 pt-4 sm:px-8">
        ...
        <Section title="앱·개발자 정보">
          본 안내는 <b>Anima</b>(이하 “서비스”) 앱의 계정 및 데이터 삭제에
          관한 것입니다. 서비스는 사용자가 작성한 미래 자아 서술과 일일 목표를
          바탕으로 매일 동기부여 카드를 제공하는 개인용 애플리케이션입니다.
          삭제와 관련한 문의는 아래 연락처로 보내실 수 있습니다.
        </Section>

        <Section title="계정을 삭제하는 방법">
          <p>
            계정과 관련 데이터는 본인이 직접, 추가 비용 없이 언제든 영구 삭제할
            수 있습니다.
          </p>
          ...
          <ol className="mt-1 list-decimal space-y-1 pl-5">
            ...
            <li>
              안내에 따라 삭제를 확인하면 계정과 데이터가 즉시 영구 삭제됩니다.
            </li>
          </ol>
          ...
          <ol className="mt-1 list-decimal space-y-1 pl-5">
            <li>
              <a
                href="https://my-successful-future.vercel.app/login"
          ...
          <p className="mt-1">
            ...
            에 삭제를 요청해 주세요. 본인 확인 후 영업일 기준 30일 이내에
            처리합니다.
          </p>
        </Section>
        ...
        <Section title="삭제되는 데이터">
          ...
          <ul className="mt-2 list-disc space-y-1 pl-5">
            ...
            <li>
              사용자가 입력한 콘텐츠 — “10년 후의 나” 서술, 일일 목표, 다짐,
              오늘 잘한 일 기록
            </li>
        ...
        <Section title="보관되는 데이터와 보관 기간">
          <p>
            아래 항목은 법령상 의무(전자상거래·세무 기록 보관) 이행을 위해
            제한적으로 보관됩니다.
          </p>
          <ul className="mt-2 list-disc space-y-1 pl-5">
            <li>
              <b>토큰 사용량·비용 회계 기록</b> — 개인을 식별하지 않는 집계
              형태로만 보관되며, 관계 법령이 정한 보관 기간 경과 후 파기됩니다.
              개인정보가 아닌 비용 정산 목적이며, 별도 마스킹을 원하시면 위
              연락처로 요청하실 수 있습니다.
            </li>
          </ul>
          <p className="mt-3">
