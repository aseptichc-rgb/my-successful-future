...
const dict: Record<DictKey, string> = {
  ...
  "onboarding.author.steveJobs": "史蒂夫·乔布斯",
  "onboarding.author.steveJobs.tag": "愿景 · 简洁",
  "onboarding.author.steveJobs.tone": "果断而直觉",
  "onboarding.author.einstein": "阿尔伯特·爱因斯坦",
  "onboarding.author.einstein.tag": "好奇 · 思辨",
  "onboarding.author.einstein.tone": "睿智而深刻",
  "onboarding.author.aurelius": "马可·奥勒留",
  "onboarding.author.aurelius.tag": "斯多葛 · 自律",
  "onboarding.author.aurelius.tone": "沉静的自省",
  "onboarding.author.angelou": "玛雅·安吉洛",
  "onboarding.author.angelou.tag": "内在 · 韧性",
  "onboarding.author.angelou.tone": "温暖而坚定",
  "onboarding.author.buffett": "沃伦·巴菲特",
  "onboarding.author.buffett.tag": "投资 · 耐心",
  "onboarding.author.buffett.tone": "务实又风趣",
  "onboarding.author.leeOryeong": "李御宁",
  "onboarding.author.leeOryeong.tag": "思想 · 韩文",
  "onboarding.author.leeOryeong.tone": "用韩文深思",
