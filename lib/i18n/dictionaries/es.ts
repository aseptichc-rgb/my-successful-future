...
const dict: Record<DictKey, string> = {
  ...
  "onboarding.author.steveJobs": "Steve Jobs",
  "onboarding.author.steveJobs.tag": "Visión · Simplicidad",
  "onboarding.author.steveJobs.tone": "Decidido e intuitivo",
  "onboarding.author.einstein": "Albert Einstein",
  "onboarding.author.einstein.tag": "Curiosidad · Pensamiento",
  "onboarding.author.einstein.tone": "Ingenio y profundidad",
  "onboarding.author.aurelius": "Marco Aurelio",
  "onboarding.author.aurelius.tag": "Estoico · Disciplina",
  "onboarding.author.aurelius.tone": "Reflexión serena",
  "onboarding.author.angelou": "Maya Angelou",
  "onboarding.author.angelou.tag": "Interior · Resiliencia",
  "onboarding.author.angelou.tone": "Cálida y firme",
  "onboarding.author.buffett": "Warren Buffett",
  "onboarding.author.buffett.tag": "Inversión · Paciencia",
  "onboarding.author.buffett.tone": "Práctico, con humor",
  "onboarding.author.leeOryeong": "Lee O-young",
  "onboarding.author.leeOryeong.tag": "Pensamiento · Coreano",
  "onboarding.author.leeOryeong.tone": "Profundo, en coreano",
  ...
  "affirmations.editor.placeholder":
    "Ej.: Soy alguien que escribe una hora cada día.",
